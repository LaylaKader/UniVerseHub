      ...
      <div className="px-6 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {[
            ...
            <div
              key={index}
              className="flex items-center p-5 bg-white shadow-lg rounded-lg border border-gray-300 transition-transform transform hover:scale-105 hover:shadow-xl">
              <item.icon className="h-8 w-8 text-indigo-600 mr-4" />
              <span
